            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3">
                 ...
                 <input type="text" name="link" readonly value="{{old('link',$menu->link)}}" id="name" class="form-control"
                ...
                <div class="mb-3">
                 <label for="link">Liên kết</label> 
                 <input type="text" name="link" value="{{old('link',$menu->link)}}" id="name" class="form-control"
                  placeholder="Nhập link">
                  @if($errors->has('link'))
                  <div class="text-danger">
                    {{$errors->first('link')}}
