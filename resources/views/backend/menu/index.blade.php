          ...
          <div class="card-header">
           <div class="row">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('menu.trash') }}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Thùng rác</a>
            </div>
           </div>
          </div>
          <div class="card-body">
                          ...
                          <div id="collapseCategory" class="collapse" aria-labelledby="headingCategory" data-parent="#accordionExample">
                            <div class="card-body">
                              ...
                              <div class="form-check">
                                ...
                                value="{{$category->id}}" id="checkCategory{{$category->id}}">
                            ...
                            @foreach ($list_topic as $topic)
                              <div class="form-check">
                                <input name ="checkIdTopic[]" class="form-check-input"
                                 type="checkbox" value="{{$topic->id}}" id="checkTopic{{$topic->id}}">
