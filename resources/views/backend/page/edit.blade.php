            ...
            <div class="row">
              <div class="col-md-9">
                <div class="mb-3">
                 ...
                 <input type="text" name="title" value="{{old('title',$page->title)}}" id="title" class="form-control"
                ...
                <div class="mb-3">
                 ...
                 <textarea name="metakey" id="metakey" class="form-control"
                  placeholder="Từ khoá tìm kiếm">{{old('metakey',$page->metakey)}}</textarea> 
                ...
                <div class="mb-3">
                 ...
                 <textarea name="detail" id="detail" class="form-control"
                  placeholder="Nhập mô tả">{{old('detail',$page->detail)}}</textarea> 
